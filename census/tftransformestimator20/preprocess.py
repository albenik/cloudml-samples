...
with warnings.catch_warnings():
  ...
  import os
  import six
  from . import input_metadata.HASH_STRING_FEATURE_KEYS
  from . import input_metadata.LABEL_KEY
  from . import input_metadata.NUMERIC_FEATURE_KEYS
  from . import input_metadata.ORDERED_COLUMNS
  from . import input_metadata.RAW_DATA_METADATA
  from . import input_metadata.STRING_TO_INT_FEATURE_KEYS
  from . import input_metadata.TO_BE_BUCKETIZED_FEATURE
